...
| Пришлёшь                        | Что предложит бот                                                            |
| ------------------------------- | ---------------------------------------------------------------------------- |
| видео                           | 🎬 смонтировать (субтитры + motion) или 📅 сразу поставить в план публикаций |
| смонтированный ролик            | 📅 запланировать публикацию одной кнопкой                                    |
| фото                            | 📅 карточку поста: куда и когда публиковать                                  |
| несколько фото одним сообщением | 📅 карусель                                                                  |

Публикация в Instagram и ВКонтакте описана отдельно — [PUBLISH.md](./PUBLISH.md).
Команды: `/plan` — что запланировано, `/status` — что уже вышло.
